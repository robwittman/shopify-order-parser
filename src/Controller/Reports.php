...
class Reports
{
    ...
    public function garmentTest($request, $response, $arguments)
    {
        return $this->view->render($response, 'reports/sales_by_garment.html', array(
            'results' =>  [
              'Long Sleeve' => [
                  'White' => [
                      'L' => 4,
    ...
    public function scheduleTest($request, $response, $arguments)
    {
        return $this->view->render($response, 'reports/print_worksheet.html', array(
            'results' => array(
                '10090900366' => array(
                    'title' => "Test Product 1 (Screen)",
                    'quantity' => 10,
                    'color_count' => 5
                ),
                '10090914126' => array(
                    'title' => "Test Product 2 (Screen w/ color override)",
                    'quantity' => 15,
                    'color_count' => 11
                ),
                '10090924622' => array(
                    'title' => "Test Product 3 (DTG)",
                    'quantity' => 4,
                    'color_count' => 3
                ),
                '10090962254' => array(
                    'title' => "Test Product 4 (DTG w/ color override)",
                    'quantity' => 4,
                    'color_count' => 12
                )
            )
